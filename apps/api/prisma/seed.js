...
var seed = function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        prompt.start();
        prompt.get(['username', 'password', 'isAdmin'], function (err, result) { return __awaiter(void 0, void 0, void 0, function () {
            var hashedPassword, token;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, argon.hash(result.password)];
                    case 1:
